        ...
        <div className="relative z-10 p-10">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mb-8 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-xl font-extrabold text-[#845cbd]">
                  {estimatedPersons || "0"}
                </p>
              </div>
          ...
          <div className="space-y-6">
            {ingredients.map((category, index) => (
              <div
                key={index}
                className="bg-white border rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden border-gray-100/80 transition-all hover:border-[#845cbd]/30 hover:shadow-[0_8px_30px_rgba(132,92,189,0.08)]"
              >
                <div className="bg-gradient-to-r from-gray-50 to-white px-5 py-3 border-b border-gray-100 flex justify-between items-center">
                  ...
                  <span className="bg-[#845cbd]/10 text-[#845cbd] border border-[#845cbd]/20 text-xs font-bold px-2.5 py-1 rounded-full">
